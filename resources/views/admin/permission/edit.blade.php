...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">{{__('Update')}} Permission</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('permissions.update', $permission->id) }}" class="validate" role="form" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                @csrf
