...
<ul id="sidebarnav">
    ...
    <li> 
        ...
        <ul aria-expanded="false" class="collapse">
            <li><a href="{{ route('menus.main.index')}}">Main</a></li>
            <li><a href="{{ route('menus.footerfirst.index')}}">Footer First</a></li>
            <li><a href="{{ route('menus.footersecond.index')}}">Footer Second</a></li>
            <li><a href="{{ route('menus.footerthird.index')}}">Footer Third</a></li>
            <li><a href="{{ route('menus.404.index')}}">404</a></li>
        </ul>
    </li>
    @endif
    @if('homePage-list')
    ...
    @can('newslatter-list')
    <li>
        <a class="waves-effect waves-dark" href="{{ route('newslatters.index') }}" aria-expanded="false">
